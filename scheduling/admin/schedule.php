		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							<label for="" class="control-label col-md-2 offset-md-2">Voir le calendrier de:</label>
							<div class=" col-md-4">
...
<script>
	...
	$('#new_schedule').click(function(){
		uni_modal('Nouvel horaire','manage_schedule.php','mid-large')
	})
	$('.view_alumni').click(function(){
		uni_modal("Biographie","view_alumni.php?id="+$(this).attr('data-id'),'mid-large')
		
	})
	$('.delete_alumni').click(function(){
		_conf("Etes-vous sûr de vouloir supprimer cet ancien élève ?","delete_alumni",[$(this).attr('data-id')])
	})
