...
<div class="modal-footer display">
	<div class="row">
		<div class="col-md-12">
			...
			<button class="btn float-right btn-danger mr-2" type="button" id="delete_schedule">Supprimer</button>
			<button class="btn float-right btn-primary mr-2" type="button" id="edit">Modifier</button>
		</div>
	</div>
</div>
<style>
...
<script>
	$('#edit').click(function(){
		uni_modal('Modifier le calendrier','manage_schedule.php?id=<?php echo $id ?>','mid-large')
	})
